  ...
  return (
    ...
    >
      ...
      <CardHeader className="pb-2">
        <CardTitle className="text-lg font-bold text-center leading-tight">
          {school.nazwa_szkoly}
        </CardTitle>
      </CardHeader>
      <CardContent>
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        if (setSelectedTab && setNewSchoolFocused) {
                          ...
                          setSelectedTab("map");
                          setNewSchoolFocused([
                            school.lokalizacja_szkoly
                              .dlugosc_geograficzna_szkoly,
                            school.lokalizacja_szkoly
                              .szerokosc_geograficzna_szkoly,
                          ]);
                          return;
                        }
    ...
    <>
      ...
      {school.rodzaje_szkoly.szkola_zawodowa?.lista_kierunkow.length > 0 ? (
        school.nazwa_szkoly !== "Zespół Szkół Ekonomicznych" ? (
          ...
          <div className="flex flex-row gap-2 justify-start items-center  py-2">
            <Badge variant="secondary">Szkoła Artystyczna</Badge>
          </div>
        )
      ) : null}
    </>
