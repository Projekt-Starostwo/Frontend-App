...
export default function LeafletMap({
  ...
  // dodac co potrzeba do tych obiektow, najwazniejsze oczywiscie te cordy, component BusSelection, zmienia tym obiektow isActive na true/false,
  //  pokazac dana linie jesli ma isActive true, przy okazji trzeba poprawic wyglad markerow dla przystankow, zeby byly widoczne jak pokazemy linie,
  // Albo polaczyc przystanki z liniami ale to wieksza robota, samo wystylowanie przystankow zrobi robote raczej,
  // w przyszlosci powinismy polaczyc przystanki z liniami imo ale nwm,
  //
  ...
  return (
    <>
      <div className='w-full z-[9999] flex flex-row justify-center items-center gap-4 flex-wrap absolute bottom-6  '>
        ...
        <Button onClick={() => setPokazPrzystanki((prevState) => !prevState)}>
          <BusFront />
