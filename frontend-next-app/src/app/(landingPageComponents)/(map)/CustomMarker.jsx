          ...
          <div className="flex flex-col justify-center items-center gap-4">
            ...
            <div className="flex flex-row h-fit w-full">
              <div className="w-[50%] flex flex-row justify-end items-center">
                <LinkButton
                  linkHref={`https://www.google.com/maps/dir/${userPosition?.[0]},${userPosition?.[1]}/${school.lokalizacja_szkoly.dlugosc_geograficzna_szkoly},${school.lokalizacja_szkoly.szerokosc_geograficzna_szkoly}`}
                  linkIcon={<MapPin color="black" />}
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <h1 className="text-black">Zobacz trasę w Google Maps</h1>
                </LinkButton>
              </div>
              <div className="w-[50%] flex flex-row justify-end items-center">
                <LinkButton
                  linkHref={`/${school.skrot_szkoly}`}
                  linkIcon={<Link2 color="black" />}
                >
